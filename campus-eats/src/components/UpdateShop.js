...
const UpdateShop = () => {
  ...
  const handleCategoryChange = (category) => {
    ...
    useEffect(() => {
        const fetchShop = async () => {
            try {
                ...
                setUploadedImage(data.shopImage);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          const response = await axios.post(`http://localhost:5000/api/shop-update/${currentUser.uid}`, formData, {
            headers: {
              ...
              <div className="sa-info">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="p-buttons">
                    <button
                      type="button"
                      onClick={() => navigate("/shop-manage-item")}
